...
// bitflags! {
//     pub struct PartType: u8 {
//         const PART_TYPE_UNKNOWN = 0x00;
//         const PART_TYPE_MAC = 0x01;
//         const PART_TYPE_DOS = 0x02;
//         const PART_TYPE_ISO = 0x03;
//         const PART_TYPE_AMIGA = 0x04;
//         const PART_TYPE_EFI = 0x05;
//         const PART_TYPE_RKPARM = 0x06;
//         const PART_TYPE_RKRAM = 0x07;
//         const PART_TYPE_ENV = 0x08;
//     }
// }

// bitflags! {
//     /// SDHCI Host Control Register
//     pub struct MmcControlRegs: u32 {
//         const SDHCI_DMA_ADDRESS = 0x00;
//         const SDHCI_BLOCK_SIZE = 0x04;
//         const SDHCI_ARGUMENT = 0x08;
//         const SDHCI_TRANSFER_MODE = 0x0C;
//         const SDHCI_COMMAND = 0xE;
//         const SDHCI_RESPONSE = 0x10;
//         const SDHCI_BUFFER = 0x20;
//         const SDHCI_PRESENT_STATE = 0x24;
//         const SDHCI_HOST_CONTROL = 0x28;
//         const SDHCI_POWER_CONTROL = 0x29;
//         const SDHCI_BLOCK_GAP_CONTROL = 0x2A;
//         const SDHCI_WAKE_UP_CONTROL = 0x2B;
//         const SDHCI_CLOCK_CONTROL = 0x2C;
//         const SDHCI_TIMEOUT_CONTROL = 0x2E;
//         const SDHCI_SOFTWARE_RESET = 0x2F;
//         const SDHCI_INT_STATUS = 0x30;
//         const SDHCI_INT_ENABLE = 0x34;
//         const SDHCI_SIGNAL_ENABLE = 0x38;
//         const SDHCI_ACMD12_ERR = 0x3C;
//         const SDHCI_HOST_CONTROL2 = 0x3E;
//         const SDHCI_CAPABILITIES = 0x40;
//         const SDHCI_CAPABILITIES_1 = 0x44;
//         const SDHCI_MAX_CURRENT = 0x48;
//         const SDHCI_SET_ACMD12_ERROR = 0x50;
//         const SDHCI_SET_INT_ERROR = 0x52;
//         const SDHCI_ADMA_ERROR = 0x54;
//         const SDHCI_ADMA_ADDRESS = 0x58;
//         const SDHCI_SLOT_INT_STATUS = 0xFC;
//         const SDHCI_HOST_VERSION = 0xFE;
//     }
// }

// bitflags! {
//     /// MMC Command Indexes
//     pub struct MmcCmdIndex: u32 {
//         const MMC_CMD_GO_IDLE_STATE = 0x00;
//         const MMC_CMD_SEND_OP_COND = 0x01;
//         const MMC_CMD_ALL_SEND_CID = 0x02;
//         const MMC_CMD_SET_RELATIVE_ADDR = 0x03;
//         const MMC_CMD_SET_DSR = 0x04;
//         const MMC_CMD_SWITCH = 0x06;
//         const MMC_CMD_SELECT_CARD = 0x07;
//         const MMC_CMD_SEND_EXT_CSD = 0x08;
//         const MMC_CMD_SEND_CSD = 0x09;
//         const MMC_CMD_SEND_CID = 0x0A;
//         const MMC_CMD_STOP_TRANSMISSION = 0x0C;
//         const MMC_CMD_SEND_STATUS = 0x0D;
//         const MMC_CMD_SET_BLOCKLEN = 0x10;
//         const MMC_CMD_READ_SINGLE_BLOCK = 0x11;
//         const MMC_CMD_READ_MULTIPLE_BLOCK = 0x12;
//         const MMC_SEND_TUNING_BLOCK = 0x13;
//         const MMC_SEND_TUNING_BLOCK_HS200 = 0x15;
//         const MMC_CMD_SET_BLOCK_COUNT = 0x17;
//         const MMC_CMD_WRITE_SINGLE_BLOCK = 0x18;
//         const MMC_CMD_WRITE_MULTIPLE_BLOCK = 0x19;
//         const MMC_CMD_ERASE_GROUP_START = 0x23;
//         const MMC_CMD_ERASE_GROUP_END = 0x24;
//         const MMC_CMD_ERASE = 0x26;
//         const MMC_CMD_APP_CMD = 0x37;
//         const MMC_CMD_SPI_READ_OCR = 0x3A;
//         const MMC_CMD_SPI_CRC_ON_OFF = 0x3B;
//         const MMC_CMD_RES_MAN = 0x3E;
//     }
// }

// bitflags! {
//     /// MMC Transfer Mode Flags
//     pub struct MmcTransferMode: u8 {
//         const SDHCI_TRNS_DMA = 1 << 0;
//         const SDHCI_TRNS_BLK_CNT_EN = 1 << 1;
//         const SDHCI_TRNS_ACMD12 = 1 << 2;
//         const SDHCI_TRNS_READ = 1 << 4;
//         const SDHCI_TRNS_MULTI = 1 << 5;
//     }
// }

// bitflags! {
//     pub struct MmcHostVersion: u32 {
//         const SDHCI_VENDOR_VER_MASK = 0xFF00;
//         const SDHCI_VENDOR_VER_SHIFT = 8;
//         const SDHCI_SPEC_VER_MASK = 0x00FF;
//         const SDHCI_SPEC_VER_SHIFT = 0;
//         const SDHCI_SPEC_100 = 0x0000;
//         const SDHCI_SPEC_200 = 0x0001;
//         const SDHCI_SPEC_300 = 0x0002;
//     }
// }

// bitflags! {
//     pub struct MmcPowerControl: u8 {
//         const SDHCI_POWER_ON = 0x01;
//         const SDHCI_POWER_180 = 0x0A;
//         const SDHCI_POWER_300 = 0x0C;
//         const SDHCI_POWER_330 = 0x0E;
//     }
// }

// bitflags! {
//     pub struct MmcSoftWareReset: u8 {
//         const SDHCI_RESET_ALL = 0x01;
//         const SDHCI_RESET_CMD = 0x02;
//         const SDHCI_RESET_DATA = 0x04;
//     }
// }

// bitflags! {
//     pub struct MmcSignalEnable: u32 {
//         const SDHCI_INT_RESPONSE = 1 << 0;
//         const SDHCI_INT_DATA_END = 1 << 1;
//         const SDHCI_INT_DMA_END = 1 << 3;
//         const SDHCI_INT_SPACE_AVAIL = 1 << 4;
//         const SDHCI_INT_DATA_AVAIL = 1 << 5;
//         const SDHCI_INT_CARD_INSERT = 1 << 6;
//         const SDHCI_INT_CARD_REMOVE = 1 << 7;
//         const SDHCI_INT_CARD_INT = 1 << 8;
//         const SDHCI_INT_ERROR = 1 << 15;
//         const SDHCI_INT_TIMEOUT = 1 << 16;
//         const SDHCI_INT_CRC = 1 << 17;
//         const SDHCI_INT_END_BIT = 1 << 18;
//         const SDHCI_INT_INDEX = 1 << 19;
//         const SDHCI_INT_DATA_TIMEOUT = 1 << 20;
//         const SDHCI_INT_DATA_CRC = 1 << 21;
//         const SDHCI_INT_DATA_END_BIT = 1 << 22;
//         const SDHCI_INT_BUS_POWER = 1 << 23;
//         const SDHCI_INT_ACMD12ERR = 1 << 24;
//         const SDHCI_INT_ADMA_ERROR = 1 << 25;
//     }
// }
